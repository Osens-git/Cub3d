...
#    Updated: 2025/06/22 19:17:13 by vluo             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC				=	$(SRC_DIR)check_file.c $(SRC_DIR)get_file_map.c	\
					$(SRC_DIR)parse_elems.c	$(SRC_DIR)parse_map.c	\
					$(SRC_DIR)drawline.c $(SRC_DIR)drawrays.c		\
					$(SRC_DIR)get_min_ray.c							\
					$(SRC_DIR)utils.c $(SRC_DIR)utils2.c			\
					$(SRC_DIR)utils3.c								\
					$(SRC_DIR)handle_input.c $(SRC_DIR)cub3d.c		\

SRC_BONUS		=	$(SRC_BONUS_DIR)check_file.c $(SRC_BONUS_DIR)get_file_map.c			\
					$(SRC_BONUS_DIR)parse_elems.c	$(SRC_BONUS_DIR)parse_map.c			\
					$(SRC_BONUS_DIR)drawline.c $(SRC_BONUS_DIR)drawrays.c				\
